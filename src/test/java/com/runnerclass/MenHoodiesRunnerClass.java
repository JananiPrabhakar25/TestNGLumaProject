...
public class MenHoodiesRunnerClass extends BaseClass_TestNG {
	...
	private void searchProductPage() {
		pageObject.getMenHoodiesSearchPageManger().getValidMenHoodiePage();
	...
	private void checkoutPage() {
		pageObject.getMenHoodiesCheckoutPageManager().getValidMenHoodiesCheckoutPage();
